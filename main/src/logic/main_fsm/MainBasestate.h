...
enum MainState { MAIN_NONE, STANDBY, RUNNING, SERVICEMODE, ERROR, ESTOP };
...
class MainBasestate {
  ...
  public:
    ...
    virtual void setData(MainContextData *data) { this->data = data; }
    virtual void setAction(MainActions *actions) { this->actions = actions; }

    virtual MainState getCurrentState() { return MAIN_NONE; };
    ...
    virtual bool master_LBA_Unblocked() {
        return false;
    }                                                     // Anfang wieder frei
    virtual bool master_LBW_Blocked() { return false; }   // Weiche blockiert
    virtual bool master_LBW_Unblocked() {
        return false;
    }                                                     // Weiche wieder frei
