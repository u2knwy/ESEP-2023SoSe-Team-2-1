...
enum MotorState { MOTOR_NONE, STOPPED, RIGHT_FAST, RIGHT_SLOW };
...
class MotorBasestate {
  ...
  public:
    ...
    virtual void setData(MotorContextData *data) { this->data = data; }
    virtual void setAction(MotorActions *actions) { this->actions = actions; }

    virtual MotorState getCurrentState() { return MOTOR_NONE; };
