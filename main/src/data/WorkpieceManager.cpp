...
void WorkpieceManager::addToArea_A(const Workpiece& wp) {
	Area_A.push(wp);
}

void WorkpieceManager::addToArea_B(const Workpiece& wp) {
	Area_B.push(wp);
}

void WorkpieceManager::addToArea_C(const Workpiece& wp) {
	Area_C.push(wp);
}

void WorkpieceManager::addToArea_D(const Workpiece& wp) {
	Area_D.push(wp);
}
