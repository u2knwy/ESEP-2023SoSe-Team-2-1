...
class IActuators : public IEventHandler {
 public:
   ...
   * If pusher is mounted: activate for {ON_TIME_PUSHER_MS} ms, then deactivate
   * again
   */
 ...
 protected:
  ...
  void subscribeToEvents() {
    ...
    if (isMaster) {
      eventManager->subscribe(
          EventType::LAMP_M_RED,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LAMP_M_YELLOW,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LAMP_M_GREEN,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::ESTOP_M_PRESSED,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_M_START,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_M_RESET,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_M_Q1,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      ...
      eventManager->subscribe(
          ...
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::SORT_M_OUT,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
    } else {
      eventManager->subscribe(
          EventType::LAMP_S_RED,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LAMP_S_YELLOW,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LAMP_S_GREEN,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::ESTOP_S_PRESSED,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_S_START,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_S_RESET,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
      eventManager->subscribe(
          EventType::LED_S_Q1,
          std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
