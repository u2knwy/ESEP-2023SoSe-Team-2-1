...
public:
	...
	void handleEvent(Event event) override {
		...
		if(!handled) {
			...
			Logger::debug("[Actuators] Event was handled: " + EVENT_TO_STRING(event.type));
		}
	}
...
protected:
	...
	void subscribeToEvents() {
		...
		// Subscribe to modes
		eventManager->subscribe(EventType::MODE_STANDBY, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		eventManager->subscribe(EventType::MODE_RUNNING, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		eventManager->subscribe(EventType::MODE_SERVICE, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		eventManager->subscribe(EventType::MODE_ESTOP, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		eventManager->subscribe(EventType::MODE_ERROR, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));

		// System-dependent events
		if (isMaster)
		{
			eventManager->subscribe(EventType::LAMP_M_RED, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LAMP_M_YELLOW, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LAMP_M_GREEN, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::ESTOP_M_PRESSED, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_M_START, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_M_RESET, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_M_Q1, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_M_Q2, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_M_STOP, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_M_FAST, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_M_SLOW, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::SORT_M_OUT, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		}
		else
		{
			eventManager->subscribe(EventType::LAMP_S_RED, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LAMP_S_YELLOW, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LAMP_S_GREEN, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::ESTOP_S_PRESSED, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_S_START, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_S_RESET, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_S_Q1, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::LED_S_Q2, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_S_STOP, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_S_FAST, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::MOTOR_S_SLOW, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
			eventManager->subscribe(EventType::SORT_S_OUT, std::bind(&IActuators::handleEvent, this, std::placeholders::_1));
		}
	}
private:
